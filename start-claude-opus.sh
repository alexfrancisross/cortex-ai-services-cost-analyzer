...
# Claude Code AWS Bedrock Setup Script - Claude Opus 4 Version
# This script configures environment variables for Claude Opus 4 and starts Claude Code

set -e  # Exit on any error

echo "🚀 Starting Claude Code with AWS Bedrock..."
echo "📍 Region: us-west-2"
echo "🤖 Primary Model: Claude Opus 4 (Most Capable)"
...
# Configure Claude models using inference profile IDs (Opus 4 as primary)
...
echo "🎯 Starting Claude Code with Claude Opus 4..."
